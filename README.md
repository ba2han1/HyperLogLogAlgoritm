...
3.Derlenen sınıfı çalıştırın:Bashjava HyperLogLog

    java HyperLogLog
  
Örnek Test SenaryosuÇalıştırılabilir main metodu içerisinde; 25.000 elemanlı A kümesi ile 20.000 elemanlı B kümesinin (5.000'i ortak) ayrı ayrı kardinaliteleri hesaplanmakta ve ardından bu iki küme birleştirilerek ($A \cup B$) toplam kardinalite (40.000) başarıyla tahmin edilmektedir.

    --- Konsol Çıktısı Örneği ---
    HLL A - Gerçek: 25000 | Tahmin: 24785 | Hata Payı: %0.86
    HLL B - Gerçek: 20000 | Tahmin: 20112 | Hata Payı: %0.56
    Birleşmiş HLL Tahmini: 40560
    Birleşim Hata Payı: %1.40
